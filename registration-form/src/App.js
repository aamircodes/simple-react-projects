  ...
  return (
    <div class='form-container'>
      <form class='register-form' onSubmit={handleSubmit}>
        ...
        <input onChange={handleLastNameInputChange} values={values.lastName} class='form-field' type='text' placeholder='Last Name' name='lastName' />
        {submitted && !values.lastName ? <span id='last-name-error'>Please enter a last name</span> : null}
        <input onChange={handleEmailInputChange} values={values.email} class='form-field' type='text' placeholder='Email' name='email' />
